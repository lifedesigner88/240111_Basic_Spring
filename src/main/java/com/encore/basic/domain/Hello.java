...
//@Getter
//@Setter
// getter, setter, 및 toString, equals등 사전 구현
...
public class Hello {
    ...
    public static MyBuilder builder(){return new MyBuilder();}
    ...
    public static class MyBuilder {
        ...
        public MyBuilder email(String email) {this.email = email;return this;}
        public MyBuilder password(String password) {this.password = password;return this;}
